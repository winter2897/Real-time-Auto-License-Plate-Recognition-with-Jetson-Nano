...
> Note: You should see the file `az_plate_ssdmobilenetv1.onnx.1.1.7103.GPU.FP16.engine`, this file is the model compiled from `az_ocr_ssdmobilenetv1.onnx` and ready to run the demo. If you want to try recompiling the file `az_ocr_ssdmobilenetv1.onnx`, just delete the file `az_plate_ssdmobilenetv1.onnx.1.1.7103.GPU.FP16.engine`.
